...
export default function ProjectCard({images, children}: ProjectCardProps) {
    return (
        <Link to="/web-design">
            <div 
                ...
                <div className="flex items-center gap-x-4">
                    <h3 className="text-[0.9375rem] font-medium tracking-[0.3125rem]">View projects</h3>
                    <FiChevronRight className="text-peach"/>
                </div>
            </div>
        </Link>        
    )
