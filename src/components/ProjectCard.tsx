    ...
    return (
        <div className="flex flex-col rounded-2xl md:flex-row md:h-77.5 2xl:flex-col 2xl:h-full">
            ...
            <Link className="md:w-1/2 rounded-b-2xl md:rounded-l-none md:rounded-r-2xl 2xl:w-full 2xl:rounded-t-none 2xl:rounded-b-2xl" to="">
                <div 
                    className="flex flex-col items-center gap-y-4 text-center bg-seashell py-8 px-7.5 rounded-b-2xl group md:justify-center md:h-full md:rounded-l-none md:rounded-r-2xl 2xl:h-39.5 2xl:rounded-t-none 2xl:rounded-b-2xl hover:bg-peach"
                >
